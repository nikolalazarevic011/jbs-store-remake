...
export default class Account extends PageManager {
    ...
    onReady() {
        ...
        const $paymentMethodForm = classifyForm(
            ...
            $bigCommerce.renderAccountPayments({
                styles: {
                    ...
                    submitButton: {
                        ...
                        backgroundColor:
                            themeSettings["button--primary-backgroundColor"],
                        borderColor:
                            themeSettings["button--primary-backgroundColor"],
                        "&:hover": {
                        ...
                        "&[disabled]": {
                            ...
                            borderColor:
                                themeSettings["button--disabled-borderColor"],
                    ...
                    cancelButton: {
                        ...
                        borderColor:
                            themeSettings["button--default-borderColor"],
                        "&:hover": {
    ...
    initAddressFormValidation($addressForm) {
        ...
        const stateSelector =
            'form[data-address-form] [data-field-type="State"]';
    ...
    initPaymentMethodFormValidation($paymentMethodForm) {
        ...
        stateCountry($stateElement, this.context, (err, field) => {
            ...
            if (
                paymentMethodValidator.getStatus($stateElement) !== "undefined"
            ) {
    ...
    registerEditAccountValidation($editAccountForm) {
        ...
        $editAccountForm.on("submit", (event) => {
            ...
            event.preventDefault();
            setTimeout(() => {
                const earliestError = $("span.form-inlineMessage:first").prev(
                    "input",
                );
    ...
    registerInboxValidation($inboxForm) {
        ...
        inboxValidator.add([
            {
                selector:
                    'form[data-inbox-form] select[name="message_order_id"]',
                validate: (cb, val) => {
            ...
            {
                selector:
                    'form[data-inbox-form] textarea[name="message_content"]',
                validate: (cb, val) => {
                    const result = val.length;
    ...
    reorderEditAccountForm($form) {
        const $email = $form
            .find('[data-field-type="EmailAddress"]')
            .closest(".form-field");
        const $currentPass = $form
            .find('[data-field-type="CurrentPassword"]')
            .closest(".form-field");
        const $newPass = $form
            .find('[data-field-type="Password"]')
            .closest(".form-field");
        ...
        if ($newPass.length) {
            const $label = $newPass.find("label");
            $label
                .contents()
                ...
                .first()
                .replaceWith("New Password ");
        }

        if ($confirmPass.length) {
            $confirmPass.parent().append($confirmPass);
            const $label = $confirmPass.find("label");
            $label
                .contents()
                .filter(function filterTextNodes() {
                    return this.nodeType === 3;
                ...
                .first()
                .replaceWith("Confirm New Password ");
        }
    }
}
