    ...
    return {
        load() {
            $(() => {
                ...
                if (window.location.href.includes('show=downloads') || window.location.href.includes('action=downloads') || window.location.href.includes('/downloads')) {
                    // Start immediately to prevent double spinner/orders page flash
