...
export const setCarouselState = ({ delegateTarget }, carouselObj) => {
    ...
    $slider.data(
        "state",
        getActiveSlideIdxAndSlidesQuantity(carouselObjCurrent),
    );
};
...
export const onSlickCarouselChange = (e, carouselObj, context) => {
    ...
    const { activeSlideIdx, slidesQuantity } =
        $slider.data("state") ||
        getActiveSlideIdxAndSlidesQuantity(carouselObj);
...
export default function (context) {
    $("[data-slick]").each((idx, carousel) => {
        ...
        let slickOptions = $carousel.data("slick") || {};
        let arrows =
            slickOptions.arrows !== undefined
                ? slickOptions.arrows
                : isMultipleSlides;
        let dots =
            slickOptions.dots !== undefined
                ? slickOptions.dots
                : isMultipleSlides;
